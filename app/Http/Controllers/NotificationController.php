...
class NotificationController extends Controller
{
    ...
    public function sendversionnotification(){
        return ['latestVersion'=>'1.0.40', 'message'=>'A new version of the app is available. Please update to the latest version for the best experience.'];
    }
    public function sendiosversionnotification(){
        return ['latestVersion'=>'1.0.38', 'message'=>'A new version of the app is available. Please update to the latest version for the best experience.'];
    }
