...
class ProcessMillageImageUpload implements ShouldQueue
{
    ...
    public function handle(): void
    {
        if (Storage::disk('public')->exists($this->path)) {
            ...
            $finalPath = 'millage_images/' . $this->filename;
            ...
            $filePath = storage_path('app/public/millage_images/'.$this->filename);
